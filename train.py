...
if __name__ == '__main__':
    ...
    # basic config
    parser.add_argument('--model_id', type=str, default='v3', help='model id')
    ...
    # forecasting task
    parser.add_argument('--train_type', type=str, default='wind', help="train which task")
    ...
    parser.add_argument('--enc_in', type=int, default=38, help='4*9+2 4个协变量 9个格点 2个因变量')
    ...
    parser.add_argument('--batch_size', type=int, default=10240, help='batch size of train input data')
    ...
    # TODO 自定添加子目录
    parser.add_argument('--tensorboard', type=str, default="/root/tf-logs/bigdata/0", help="Whether to use tensorboard. Set None to disable")
    ...
    for ii in range(args.itr):
        ...
        setting = f'{datetime.now().strftime("%m%d%H")}-{args.train_type}'
