...
class Model(nn.Module):
    def __init__(self, args) -> None:
        ...
        self.fc1 = nn.Linear(self.output_dim, args.lstm_hidden_size, dtype=float)
        self.lstm = nn.LSTM(input_size=args.lstm_hidden_size,
                            hidden_size=args.lstm_hidden_size,
                            num_layers=args.lstm_layer_num,
                            batch_first=True,
                            dropout=args.dropout)
        self.fc2 = nn.Linear(args.lstm_hidden_size, args.label_len, dtype=float)
